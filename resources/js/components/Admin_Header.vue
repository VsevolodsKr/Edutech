        ...
        <section class="flex items-center justify-between relative py-[.5rem] px-[1.5rem]">
            ...
            <Transition name="menu">
                ...
                >
                    ...
                    <h3 class="text-[1.5rem] text-text_dark text-ellipsis whitespace-nowrap [@media(max-width:550px)]:text-[1.1rem]">{{ adminData.name }}</h3>
                    <p class="text-[1.3rem] text-text_light [@media(max-width:550px)]:text-[.9rem]">{{ adminData.profession }}</p>
